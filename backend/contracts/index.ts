 ...
 *
 * SINGLE SOURCE OF TRUTH for types and runtime validators.
 * This file is synced to frontend via scripts/sync-contracts.sh
 *
 * Update process:
 * 1. Edit this file in backend/contracts/
 * 2. Run frontend sync script
 * 3. Verify builds pass in both backend and frontend
 *
 * Per 10_data_model.md and 12_ai_prompts.md
 */
