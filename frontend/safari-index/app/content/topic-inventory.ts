...
export const topicInventory: TopicInventoryItem[] = [
  ...
  // ============================================================
  // BUCKET 9: BIRDING (12 topics)
  // "Safari birding decisions for serious ornithologists"
  // ============================================================
  {
    id: 'birding-green-vs-dry-season',
    title: 'Is green season or dry season better for safari birding?',
    bucket: 'experience_type',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Migratory timing vs resident visibility; breeding plumage trade-offs',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'Can I combine serious birding with Big Five game viewing?',
    bucket: 'experience_type',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Pace conflicts; vehicle positioning trade-offs; guide expertise requirements',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'Uganda or Tanzania for endemic forest birding?',
    bucket: 'destination_choice',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Albertine Rift endemics vs Eastern Arc endemics; habitat access trade-offs',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: true,
  },
  {
    ...
    title: 'When is peak timing for Palearctic migrants on safari?',
    bucket: 'timing',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Nov-Mar optimal but varies by species; regional arrival patterns',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'Is birding compatible with wildlife photography goals?',
    bucket: 'experience_type',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Equipment weight; patience trade-offs; vehicle modification needs',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'Can I have a meaningful birding safari in under 7 days?',
    bucket: 'logistics',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Species count vs habitat diversity trade-offs; focused itinerary design',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'How does forest birding affect mammal sighting opportunities?',
    bucket: 'experience_type',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Dense canopy limits vehicle viewing; walking focus shifts experience',
    launch_priority: 'P1',
    seo_intent: 'medium',
    compare_enabled: false,
  },
  {
    ...
    title: 'Are private concessions worth it for birding?',
    bucket: 'accommodation',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Off-road access helps but bird density often similar; cost trade-offs',
    launch_priority: 'P1',
    seo_intent: 'medium',
    compare_enabled: false,
  },
  {
    ...
    title: 'How does rainfall affect birding safari expectations?',
    bucket: 'timing',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Breeding displays vs accessibility; waterbird congregation patterns',
    launch_priority: 'P1',
    seo_intent: 'medium',
    compare_enabled: false,
  },
  {
    ...
    title: 'Are fly-in safaris limiting for birders?',
    bucket: 'logistics',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Road birding opportunities lost; luggage limits for optics and guides',
    launch_priority: 'P1',
    seo_intent: 'medium',
    compare_enabled: false,
  },
  {
    ...
    title: 'What are the ethics of playback for bird attraction on safari?',
    bucket: 'risk_ethics',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Species-specific sensitivity; breeding season concerns; guide practices',
    launch_priority: 'P1',
    seo_intent: 'medium',
    compare_enabled: false,
  },
  {
    ...
    title: 'Does birding conflict with predator tracking on safari?',
    bucket: 'experience_type',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Dawn timing conflicts; vehicle speed differences; guide skill sets',
    launch_priority: 'P1',
    seo_intent: 'medium',
    compare_enabled: false,
  },
  ...
  // ============================================================
  // BUCKET 10: MIGRATION (7 topics)
  // "Great Migration decisions for the upcoming season"
  // ============================================================
  {
    id: 'migration-month-position',
    title: 'Where should I position myself to see the migration?',
    bucket: 'timing',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Location varies by month; wrong region means missing herds entirely',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'Should my first safari focus on the migration?',
    bucket: 'personal_fit',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'First-timer satisfaction correlates with diversity, not singular events',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    id: 'migration-crowds',
    title: 'Can I see the migration without the crowds?',
    bucket: 'experience_type',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Exclusivity and migration access pull in opposite directions',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    id: 'migration-cost',
    title: 'Why does migration safari cost more?',
    bucket: 'value_cost',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Demand peaks when migration is accessible; remote camps cost more',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'River crossings or calving season?',
    bucket: 'timing',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Different spectacles, different seasons, different trade-offs',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: true,
  },
  {
    ...
    title: 'How many days do I need for a migration safari?',
    bucket: 'logistics',
    decision_complexity: 'conditional',
    assurance_eligible: true,
    assurance_rationale: 'Crossing odds increase with time; minimum viable differs by goal',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: false,
  },
  {
    ...
    title: 'Serengeti or Mara for migration viewing?',
    bucket: 'destination_choice',
    decision_complexity: 'multi-factor',
    assurance_eligible: true,
    assurance_rationale: 'Same ecosystem, different access rules, different crowd dynamics',
    launch_priority: 'P0',
    seo_intent: 'high',
    compare_enabled: true,
  },
