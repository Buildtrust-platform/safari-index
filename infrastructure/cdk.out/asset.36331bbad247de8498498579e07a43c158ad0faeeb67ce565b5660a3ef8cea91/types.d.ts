 ...
 */
export type TaskType = 'DECISION' | 'REFUSAL' | 'REVISION' | 'TRADEOFF_EXPLANATION' | 'CLARIFICATION';
export type TravelerType = 'first_time' | 'repeat' | 'family' | 'honeymoon' | 'photographer' | 'unknown';
 ...
 */
export type RefusalCode = 'SERVICE_DEGRADED' | 'MISSING_INPUTS' | 'CONFLICTING_INPUTS' | 'GUARANTEE_REQUESTED';
...
export type AIOutput = DecisionOutput | RefusalOutput | ClarificationOutput | TradeoffExplanationOutput | RevisionOutput;
