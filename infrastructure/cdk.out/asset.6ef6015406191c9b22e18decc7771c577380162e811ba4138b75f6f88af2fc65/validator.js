...
exports.detectInputConflicts = detectInputConflicts;
const VALID_TASKS = [
    'DECISION',
    'REFUSAL',
    'REVISION',
...
const VALID_BUDGET_BANDS = [
    'budget',
    'fair_value',
    'premium',
    'unknown',
];
const VALID_PACE_PREFERENCES = [
    'slow',
    'balanced',
    'fast',
    'unknown',
];
const VALID_RISK_TOLERANCES = [
    'low',
    'medium',
    'high',
    'unknown',
...
function validateUserContext(context, errors) {
    ...
    if (context.drive_tolerance_hours === undefined ||
    ...
    else if (typeof context.drive_tolerance_hours !== 'number' ||
 ...
 */
function detectInputConflicts(input) {
    const conflicts = [];
    ...
    if (input.user_context.budget_band === 'budget' &&
        input.request.constraints &&
        input.request.constraints.comfort_level === 'luxury') {
