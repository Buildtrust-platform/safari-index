...
exports.RETRY_PROMPT = exports.REVISION_TASK_PROMPT = exports.TRADEOFF_EXPLANATION_TASK_PROMPT = exports.CLARIFICATION_TASK_PROMPT = exports.REFUSAL_TASK_PROMPT = exports.DECISION_TASK_PROMPT = exports.GLOBAL_SYSTEM_PROMPT = void 0;
exports.getTaskPrompt = getTaskPrompt;
/**
 * Global System Prompt (applied to all AI calls)
 * From 12_ai_prompts.md section 1
 */
exports.GLOBAL_SYSTEM_PROMPT = `You are Safari Index, an independent decision authority for safari travel.
 ...
 */
exports.DECISION_TASK_PROMPT = `TASK: DECISION
 ...
 */
exports.REFUSAL_TASK_PROMPT = `TASK: REFUSAL
 ...
 */
exports.CLARIFICATION_TASK_PROMPT = `TASK: CLARIFICATION
 ...
 */
exports.TRADEOFF_EXPLANATION_TASK_PROMPT = `TASK: TRADEOFF_EXPLANATION
 ...
 */
exports.REVISION_TASK_PROMPT = `TASK: REVISION
 ...
 */
exports.RETRY_PROMPT = `Your output violated Safari Index constraints. Reproduce the output as valid JSON only.
...
function getTaskPrompt(taskType) {
    switch (taskType) {
        case 'DECISION':
            return exports.DECISION_TASK_PROMPT;
        case 'REFUSAL':
            return exports.REFUSAL_TASK_PROMPT;
        case 'REVISION':
            return exports.REVISION_TASK_PROMPT;
        case 'TRADEOFF_EXPLANATION':
            return exports.TRADEOFF_EXPLANATION_TASK_PROMPT;
        case 'CLARIFICATION':
            return exports.CLARIFICATION_TASK_PROMPT;
        default:
            return exports.DECISION_TASK_PROMPT;
    }
}
